  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://my-ai-doctor-server.onrender.com/api/patient/patientcontact/`,
        {
          method: "POST",
          headers: {
          ...
          <Row className="mb-3">
            <Col md={6}>
              <Form.Group controlId="email">
                <Form.Label className="fs-15 fw-semibold">Email</Form.Label>
                <Form.Control
                  type="email"
                  name="email"
          ...
          <Row className="mb-3">
            ...
            <Col md={6}>
              <Form.Group controlId="city">
                <Form.Label className="fs-15 fw-semibold">City</Form.Label>
                <Form.Control
                  type="text"
                  name="city"
                  value={formData.city}
          ...
          <Row className="mb-3">
            <Col md={6}>
              <Form.Group controlId="state">
                <Form.Label className="fs-15 fw-semibold">State</Form.Label>
                <Form.Control
                  type="text"
                  name="state"
            ...
            <Col md={6}>
              <Form.Group controlId="country">
                <Form.Label className="fs-15 fw-semibold">Country</Form.Label>
                <Form.Control
                  type="text"
                  name="country"
