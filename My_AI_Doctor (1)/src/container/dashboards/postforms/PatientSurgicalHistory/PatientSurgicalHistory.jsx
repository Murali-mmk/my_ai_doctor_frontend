...
function PatientSurgicalHistory() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://my-ai-doctor-server.onrender.com/api/patient/surgicalhistory/",
        {
          method: "POST",
          headers: {
          ...
          <Row className="mb-3">
            <Col>
              <Form.Group controlId="hospital">
                <Form.Label className="fs-15 fw-semibold">Hospital</Form.Label>
                <Form.Control
                  type="text"
                  name="hospital"
            ...
            <Col>
              <Form.Group controlId="surgeon">
                <Form.Label className="fs-15 fw-semibold">Surgeon</Form.Label>
                <Form.Control
                  type="text"
                  name="surgeon"
          ...
          <Row className="mb-3">
            <Col>
              <Form.Group controlId="outcome">
                <Form.Label className="fs-15 fw-semibold">Outcome</Form.Label>
                <Form.Control
                  type="text"
                  name="outcome"
