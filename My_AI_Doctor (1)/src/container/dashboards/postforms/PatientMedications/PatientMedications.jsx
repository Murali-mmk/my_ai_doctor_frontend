  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://my-ai-doctor-server.onrender.com/api/patient/patient-medications/create/",
        {
          method: "POST",
          headers: {
          ...
          <Row className="mb-3">
            ...
            <Col>
              <Form.Group controlId="dosage">
                <Form.Label className="fs-15 fw-semibold">Dosage</Form.Label>
                <Form.Control
                  type="text"
                  name="dosage"
          ...
          <Row className="mb-3">
            <Col>
              <Form.Group controlId="frequency">
                <Form.Label className="fs-15 fw-semibold">Frequency</Form.Label>
                <Form.Control
                  type="text"
                  name="frequency"
          ...
          <Row className="mb-3">
            <Col>
              <Form.Group controlId="endDate">
                <Form.Label className="fs-15 fw-semibold">End Date</Form.Label>
                <Form.Control
                  type="date"
                  name="end_date"
          ...
          <Row className="mb-3">
            <Col>
              <Form.Group controlId="purpose">
                <Form.Label className="fs-15 fw-semibold">Purpose</Form.Label>
                <Form.Control
                  type="text"
                  name="purpose"
