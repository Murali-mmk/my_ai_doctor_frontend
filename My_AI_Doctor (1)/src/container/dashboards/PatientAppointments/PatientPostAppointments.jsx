            ...
            <Col>
              <Form.Group controlId="department">
                ...
                <Select
                  ...
                  value={
                    departments
                      ? departments.find((dept) => dept.department_id === formData.department_id)
                      : null
                  }
            ...
            <Col>
              <Form.Group controlId="doctor">
                ...
                <Select
                  ...
                  value={
                    doctors
                      ? doctors.find((doctor) => doctor.doctor_id === formData.doctor_id)
                      : null
                  }
            ...
            <Col>
              <Form.Group controlId="status">
                ...
                <Select
                  ...
                  value={
                    statusOptions.find((status) => status.value === formData.status) || null
                  }
