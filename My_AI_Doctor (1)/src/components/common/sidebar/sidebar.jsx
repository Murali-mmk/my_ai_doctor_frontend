...
// import logo1 from "../../../assets/images/brand-logos/desktop-logo.png"; //rectangle... //logo.jpeg
// import logo2 from "../../../assets/images/brand-logos/toggle-logo.png";//square //siderimage 3
    ...
    <Fragment>
      ...
      <aside className="app-sidebar sticky" id="sidebar" onMouseEnter={() => Onhover()}
        ...
        <div className="main-sidebar-header">
          <Link to={`${import.meta.env.BASE_URL}dashboards/patient/`} className="header-logo">
            <img src={desktoplogo} alt="logo" className="desktop-logo" />
            <img src={sliderimg3} alt="logo" className="toggle-logo" />
            <img src={desktoplogo} alt="logo" className="desktop-dark" />
            <img src={sliderimg3} alt="logo" className="toggle-dark" />
            <img src={desktoplogo} alt="logo" className="desktop-white" />
            <img src={sliderimg3} alt="logo" className="toggle-white" />
          </Link>
        </div>
