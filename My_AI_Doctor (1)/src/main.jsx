...
import  PatientDetails from './container/dashboards/PatientDetails/PatientDetails.jsx';
import PatientAllergies from './container/dashboards/PatientAllergies/PatientAllergies.jsx';
import PatientDocuments from './container/dashboards/PatientDocuments/PatientDocuments.jsx';
import Patient_Billing from './container/dashboards/PatientBilling/PatientBilling.jsx';
import Patient_Consent_Records from './container/dashboards/PatientConsentRecords/Patient_Consent_Records.jsx';
import Contact_details from './container/dashboards/ContactDetails/ContactDetails.jsx';
import Emergency_contact from './container/dashboards/EmergencyContact/EmergencyContacts.jsx';
import FamilyMedicalHistory from './container/dashboards/FamilyMedicalHistory/FamilyMedicalHistory.jsx';
import InsuranceDetails from './container/dashboards/InsuranceDetails/InsuranceDetails.jsx';
import PatientAuditTrail from './container/dashboards/PatientAuditTrail/PatientAuditTrail.jsx';
import PatientMedicalConditions from './container/dashboards/PatientMedicalConditions/PatientMedicalConditions.jsx';
import SurgicalHistory from './container/dashboards/SurgicalHistory/SurgicalHistory.jsx';
import DoctorDetails from './container/dashboards/Doctor_Details/Doctor_details.jsx';
...
// import PatientPostSurgicalHistory from './container/dashboards/SurgicalHistory/PatientPostSurgicalHistory.jsx';
// import PatientPostVitalSigns from './container/dashboards/PatientVitalSigns/PatientPostVitalSigns.jsx';
// import PatientPostMedicalConditions from './container/dashboards/PatientMedicalConditions/PatientPostMedicalConditions.jsx';
// import PatientPostMedications from './container/dashboards/PatientMedications/PatientPostMedications.jsx';
// import PatientPostFamilyMedicalHistory from './container/dashboards/FamilyMedicalHistory/PatientPostFamilyMedicalHistory.jsx';
// import PatientPostDetails from './container/dashboards/PatientDetails/PatientPostDetails.jsx';
// import PatientPostDocuments from './container/dashboards/PatientDocuments/PatientPostDocuments.jsx';
// import PatientPostAllergies from  './container/dashboards/PatientAllergies/PatientPostAllergies.jsx';
// import PatientPostImmunizations from './container/dashboards/PatientImmunizations/PatientPostImmunizations.jsx';
// import PatientPostInsuranceDetails from './container/dashboards/InsuranceDetails/PatientPostInsuranceDetails.jsx';
// import PatientPostPaymentMethods from './container/dashboards/PatientPaymentMethods/PatientPostPaymentMethods.jsx';
// import ContactPostDetails from './container/dashboards/ContactDetails/ContactPostDetails.jsx';
// import EmergencyPostContactDetails from './container/dashboards/EmergencyContact/EmergencyPostContactDetails.jsx';
  ...
  <BrowserRouter>
    <React.Suspense fallback={<Loader/>}>
      ...
      <Route path={`${import.meta.env.BASE_URL}`} element={<Auth />}>
          ...
          <Route path={`${import.meta.env.BASE_URL}firebase/login`} element={<Signincover />} />
          <Route path={`${import.meta.env.BASE_URL}firebase/signup`} element={<Signupcover />}/>
       </Route>
          <Route path={`${import.meta.env.BASE_URL}`} element={<App/>}>
          
          <Route path={`${import.meta.env.BASE_URL}dashboards/patient`} element={<PatientDetails/>} />
          <Route path={`${import.meta.env.BASE_URL}dashboards/patient-allergies`} element={<PatientAllergies />} />
          <Route path={`${import.meta.env.BASE_URL}dashboards/patient-documents`} element={<PatientDocuments />} />
          <Route path={`${import.meta.env.BASE_URL}dashboards/patient-billing`} element={<Patient_Billing />} />
          <Route path={`${import.meta.env.BASE_URL}dashboards/patient-consent-records`} element={<Patient_Consent_Records />} />
          <Route path={`${import.meta.env.BASE_URL}dashboards/contact-details`} element={<Contact_details/>} />
          <Route path={`${import.meta.env.BASE_URL}dashboards/emergency-contact`} element={<Emergency_contact />} />
          <Route path={`${import.meta.env.BASE_URL}dashboards/family-medical-history`} element={<FamilyMedicalHistory />} />
          <Route path={`${import.meta.env.BASE_URL}dashboards/insurance-details`} element={<InsuranceDetails />} />
          <Route path={`${import.meta.env.BASE_URL}dashboards/patient-audit-trail`} element={<PatientAuditTrail />} />
          <Route path={`${import.meta.env.BASE_URL}dashboards/patient-medical-conditions`} element={<PatientMedicalConditions />} />
          <Route path={`${import.meta.env.BASE_URL}dashboards/surgical-history`} element={<SurgicalHistory />} />

          <Route path={`${import.meta.env.BASE_URL}dashboards/doctorslist`} element={<DoctorsList />} />
